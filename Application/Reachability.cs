...
namespace NSPersonalCloud.DarwinMobile
{
    ...
    {
        public static string HostName = "www.apple.com";
        ...
        //
        public static event Action<NetworkReachabilityFlags> ReachabilityChanged;
        ...
        public static NetworkStatus RemoteHostStatus()
        {
            ...
            if (remoteHostReachability == null)
            {
                ...
                // this only happens when you create NetworkReachability from a host name
